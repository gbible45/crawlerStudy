    ...
    try:
        ...
        while while_loop :
            if date_type != "d": # 월단위 검색
                ...
                print(chrome, cvsFileName, search_encode, run_start_time.strftime("%Y-%m-%d"), run_end_time.strftime("%Y-%m-%d"), encode_type)
                time.sleep(1)
                searchWeb(chrome, cvsFileName, search_encode, run_start_time.strftime("%Y-%m-%d"), run_end_time.strftime("%Y-%m-%d"), encode_type)
                ...
                print(chrome, cvsFileName, search_encode, run_time.strftime("%Y-%m-%d"), run_end_time.strftime("%Y-%m-%d"), encode_type)
                time.sleep(1)
                searchWeb(chrome, cvsFileName, search_encode, run_time.strftime("%Y-%m-%d"), run_end_time.strftime("%Y-%m-%d"), encode_type)
